    ...
    <div class="popup-content">
        <div class="popup-content-inner">
            <div class="videowraper_ar">
                ...
                <iframe id="popupVideo" src="<?php echo get_field('watch_video_url'); ?>"></iframe>
    ...
    <div class="container_ar_mi">
        <div class="d-flex-left-ar">
            ...
            <div class="trythemcolumn_ar">
                ...
                ?>
                <div class="getstartedbtn get_price_list_popup"><a
                        href="<?php echo get_field('why_us_section_button_link'); ?>"><?php echo get_field('why_us_section_button_text'); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="show_slide_img">
    <div class="overlay">
        <div class="img-show_slide">
            <span>&times;</span>
            <img src="">
        </div>
    </div>
                        ...
                        <div class="benefits_card_body_ar">
                            <div class="d-flex-ar-mi">
                                ...
                                <div class="linkbuttons_ar">
                                    <a href="<?php echo get_sub_field('category_link'); ?>"
                                        class="getstartedbtn"><?php include get_template_directory() . '/assets/img/arrow_icon_rigt.svg' ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="prange_card_ar">
                        ...
                        <div class="prange_card_body_ar">
                            <div class="d-flex--column-ar-mi">
                                ...
                                <div class="linkbuttons_ar">
                                    <a href="<?php echo get_sub_field('product_category_diy_button_link'); ?>"
                                        class="getstartedbtn"><?php echo get_sub_field('product_category_diy_button_text'); ?></a>
                                    <a href="<?php echo get_sub_field('product_category_trade_button_link'); ?>"
                                        class="getstartedbtn"><?php echo get_sub_field('product_category_trade_button_text'); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="testimon_slider" id="testimon_slider">
                <div class="testimon_mi_ar owl-carousel">
                    <?php while (have_rows('testimonials_slider')):
                        ...
                        $videourl = get_sub_field('testimonial_video_url');
                        $thumbnail = get_sub_field('video_picturethumbnail');
                        ?>
                            ...
                            <div class="testimon_card_body_ar">
                                <div class="d-flex--column-ar-mi slide">
                                    ...
                                    <div class="testimon_content_img">
                                        ...
                                        <div class="play_button_for_straight" data-videourl="<?php echo $videourl; ?>">
                ...
                <div class="slider_controls test_slider_controls_ar">
                    ...
                    <div class="price_list_btn_ar">
                        <a href="<?php echo get_field('testimonial_section_button_link'); ?>"
                            class="price_list_btn get_price_list_popup"><?php echo get_field('testimonial_section_button_text'); ?></a>
                    </div>
...
<!-- Modal for Video -->
<div id="videoModal_testi" class="modal_testi">
    <div class="modal_testi-content">
        <span class="close_testi">&times;</span>
        <iframe id="videoIframe_testi" width="560" height="315" src="" frameborder="0" allowfullscreen></iframe>
    </div>
</div>
