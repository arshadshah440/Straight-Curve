<?php
	...
	if (current_site() === 'nl' && !is_live()) {
		$sheet_pages[15] = array(
			'url' => '/nl/garden-solutions/planter-boxes/',
			'title' => 'DIY Planter Boxes'
		);
		$sheet_pages[16] = array(
			'url' => '/nl/garden-solutions/planter-boxes/',
		...
		$sheet_pages[11] = array(
			'url' => '/nl/garden-solutions/garden-edging/',
			'title' => 'DIY Garden Edging'
		);
		$sheet_pages[7] = array(
			'url' => '/nl/garden-solutions/raised-garden-beds/',
			'title' => 'DIY Raised Garden Beds'
		);
		$sheet_pages[6] = array(
			'url' => '/nl/garden-solutions/',
			'title' => 'DIY Products'
		);
	}
...
<ul id="menu" class="c-nav d-flex row-wrap align-items-center">
	<?php if (!disable_shop() && (current_site() === 'uk' || current_site() === 'au' || (current_site() === 'nl' && !is_live()))) : ?>
	...
	<li class="menu-item menu-item-has-children level-0 solutions">
		...
		<?php if (current_site() === 'uk' || current_site() === 'au' || (current_site() === 'nl' && !is_live()) || (current_site() === 'us' && !is_live())) : ?>
