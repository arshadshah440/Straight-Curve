		...
		<tbody>
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					?>
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>" data-product="<?php echo $_product->get_id(); ?>">
						...
						<td class="product-image">
							<?php
								...
								if ( ! $product_permalink ) {
									printf( '<span style="background-image: url(%s)"></span>', $image_url );
								} else {
									printf( '<a href="%s" style="background-image: url(%s)"></a>', esc_url( $product_permalink ), $image_url );
								}
							?>
						</td>
						...
						<td class="product-remove">
							<?php
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="fal fa-minus-circle" aria-hidden="true"></i></a>',
			...
			<tr class="actions">
				<td colspan="6">
					<div class="o-layout">
						...
						if ( current_site() !== 'nl' && wc_coupons_enabled() ) { ?>
							<div class="o-layout__item u-1/2@tablet coupon">
						...
						<div class="o-layout__item u-1/2@tablet c-cart__update-btn">
