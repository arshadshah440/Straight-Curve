            ...
            <div class="testimon_slider" id="testimon_slider">
                ...
                <div class="slider_controls test_slider_controls_ar">
                    ...
                    <div class="price_list_btn_ar">
                        <a href="<?php echo get_field('testimonial_section_button_link'); ?>" class="price_list_btn get_price_list_popup"><?php echo get_field('testimonial_section_button_text'); ?></a>
                    </div>
...
?>
<div class="practreason pad_top_bottom_90 landscape_acoordian_ar" id="homeaccordiana_ar">
    <div class="container_ar_mi">
