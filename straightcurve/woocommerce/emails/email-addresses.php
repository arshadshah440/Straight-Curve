...
?><table id="addresses" border="0" cellpadding="20" cellspacing="0" width="100%"><tr><td class="wrap" valign="top">
	<table cellspacing="0" cellpadding="0" style="width: 100%; vertical-align: top; padding:0;" border="0">
		<tr>
			...
			<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && $shipping ) : ?>
				<td style="text-align:<?php echo esc_attr( $text_align ); ?>; font-family: Arial, sans-serif; padding:0;" valign="top" width="50%">
