...
<div class="practreason pad_top_bottom_80_90" id="footer_pricelist_ar">
    <div class="container_ar_mi">
        ...
        <div class="cta_btn_ar">
            <a href="<?php echo get_field('footer_price_list_section_button_link', 'option'); ?>" class="getstartedbtn"><?php echo get_field('footer_price_list_section_button_text', 'option'); ?></a>
        </div>
    </div>
</div>